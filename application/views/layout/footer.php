...
<div class="row">
    <div class="footer-bottom">
        <div class="copyright-txt">
            <p>&copy; <?php echo date('Y') ?>. Designer By <a href="http://localhost/compro" title="Java Web Media">@ Selempang Betawi</a></p>
        </div>
        <!-- .copyright-txt -->
        <div class="social-box">
            <ul class="social-icon-rounded">
                ...
                <li><a href="<?php echo $site->google_plus ?>"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
            </ul>
        </div>
        <!-- .social-box -->
