            ...
            <div class="contact-us">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <form action="<?php echo base_url('kontak/send') ?>" method="POST" enctype="multipart/form-data" class="contact-form">
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <textarea class="form-control text-area" rows="3" id="messageId" name="message" placeholder="Message"></textarea>
