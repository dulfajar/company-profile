                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="blog-items">
                                    <div class="blog-img" >
                                        <a href="<?php echo base_url('berita/read/' . $berita->slug_berita); ?>"><img style="width:570px;height:300px;" src="<?php echo base_url('assets/upload/image/'.$berita->gambar) ?>"  alt="upcoming-events-img-1" class="img-responsive" /></a>
                                    </div>
                                    <!-- .blog-img -->
